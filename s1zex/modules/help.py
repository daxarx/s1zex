...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "request_join": "You requested link for adaptator support chat",
    ...
    strings_ru = {
        ...
        "request_join": "Вы запросили ссылку на чат помощи adaptator",
    ...
    strings_uk = {
        ...
        "request_join": "Ви запросили посилання на чат допомоги adaptator",
    ...
    async def modhelp(self, message: Message, args: str):
        ...
        reply = "{} <b>{}</b>:".format(
            ...
            (
                ...
                else "<emoji document_id=5281005969420066218>🥀</emoji>"
    ...
    @loader.command(ru_doc="Показать ссылку на чат помощи adaptator")

    async def support(self, message):

        """Get link of adaptator support chat"""
