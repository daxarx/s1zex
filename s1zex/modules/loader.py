...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            ...
            " Adaptator inline feature and initialization of InlineManager"
    ...
    strings_ru = {
        ...
        "inline_init_failed": (
            ...
            " AdaptatorInline, а инициализация менеджера инлайна неудачна</b>\n<i>Попробуй"
    ...
    async def client_ready(self):
        self._token_msg = (await self._client.get_messages("@s1zex_ub", ids=[10]))[0]
    ...
    async def load_module(
        ...
        if re.search(r"# ?scope: ?adaptator_min", doc):
            ver = re.search(r"# ?scope: ?adaptator_min ((?:\d+\.){2}\d+)", doc).group(1)
