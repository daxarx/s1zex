...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_s1zex": (
            "🥀 <b>Hi! This is Adaptator, UserBot that is based on the best UserBot s1zex. You can"
            " install it to your account!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/s1zexxx/Adaptator">GitHub</a></b>\n<b>🥀 <a'
    ...
    strings_ru = {
        ...
        "bot_updated": (
            ...
            " Для их применения нужно перезагрузить Adaptator</b>"
        ),
        "this_is_s1zex": (
            "🥀 <b>Привет! Это Adaptator, ЮзерБот основанный на s1zex. Вы можете"
    ...
    strings_uk = {
        ...
        "bot_updated": (
            ...
            " Для їх застосування потрібно перезавантажити Adaptator</b>"
        ),
        "this_is_s1zex": (
            "🥀 <b>Привіт! Це Adaptator, заснований на s1zex. Ви можете"
    ...
    async def ch_s1zex_bot(self, message: Message):
        """<username> - Change your Adaptator inline bot username"""
