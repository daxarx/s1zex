...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """👋🏻 <b>Hi!</b> I am a <B> inline-bot Adaptator</B>, then let's go through a little training and configure Adaptator for your needs
...
<i> 🔺 More usage guides can be found in the chat </i><a href="https://t.me/s1zexzxc">Adaptator

</a><i> 🤝 <b>Adaptator</b> is based on <b>Adaptator</b>, therefore supports modules <b>Adaptator</b>, <b>FTG</b>, <b>DragonUB</b> and <b>GeekTG</b> and their own.</i>""",
        "railway": (
            ...
            " <b>Adaptator will be frozen</b>. Next month <b>you will need to go to"
            " https://railway.app and restart it</b>."
        ),
        "language_saved": "🇬🇧 Language saved!",
        "language": "🇬🇧 English",
        "btn_support": "🥀 Adaptator Chat",
    }

    strings_ru = {
        "base": """👋🏻 <b>Привет!</b> Я являюсь<b> Inline-ботом Adaptator</b>, давай пройдем небольшое обучение и настроим Adaptator под твои нужды 
...
</b>💥 <i>Вы можете найти каналы подтверждённых разработчиков можно найти </i><a href="https://t.me/s1zexbee"><i>клик
...
<i>🔺 Больше гайдов по использованию можете найти в чате </i><a href="https://t.me/s1zexzxc">Adaptator

</a><i>🤝 <b>Adaptator</b> основан на <b>s1zex</b>, поэтому поддерживает модули <b>s1zex</b>, <b>FTG</b>, <b>DragonUB</b> и <b>GeekTG</b> и свои собственные.</i>
""",
        "railway": (
                ...
                [
                    {
                        ...
                        "url": "https://t.me/INVERSIYA_EBAW",
                    },
                    {
                        "text": "Telegram Chanel",
