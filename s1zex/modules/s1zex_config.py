...
@loader.tds
class AdaptatorConfigMod(loader.Module):
    """Interactive configurator for adaptator Userbot"""

    strings = {
        "name": "AdaptatorConfig",
    ...
    strings_ru = {
        ...
        "_cls_doc": "Интерактивный конфигуратор adaptator",
    ...
    strings_uk = {
        ...
        "_cls_doc": "Інтерактивний конфігуратор adaptator",
