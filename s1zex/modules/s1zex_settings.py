...
@loader.tds
class AdaptatorSettingsMod(loader.Module):
    """Advanced settings for adaptator Userbot"""

    strings = {
        "name": "AdaptatorSettings",
        "watchers": (
        ...
        "inline_settings": "⚙️ <b>Here you can configure your adaptator settings</b>",
        "confirm_update": (
        ...
        "nonick_warning": (
            ...
            "You may get muted in adaptator chats. Change prefix or "
            "disable NoNick!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove adaptator from this account and can't be"
            " reverted!</b>\n\n<i>- adaptator chats will be removed\n- Session will be"
            " terminated and removed\n- adaptator inline bot will be removed</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Are you really sure you want to delete adaptator?</b>"
        ),
        "deauth_yes": "I'm sure",
        ...
        "uninstall": "😢 <b>Uninstalling adaptator...</b>",
        "uninstalled": (
            "😢 <b>adaptator uninstalled. Web interface is still active, you can add another"
            " account</b>"
        ),
        "cmd_nn_list": (
        ...
        "privacy_leak": (
            "⚠️ <b>This command gives access to your adaptator web interface. It's not"
        ...
        "opening_tunnel": "🔁 <b>Opening tunnel to adaptator web interface...</b>",
        "tunnel_opened": "🎉 <b>Tunnel opened. This link is valid for about 1 hour</b>",
        "web_btn": "🌍 Web interface",
        "btn_yes": "🚸 Open anyway",
        "btn_no": "🔻 Cancel",
        "lavhost_web": (
            "✌️ <b>This link leads to your adaptator web interface on lavHost</b>\n\n<i>💡"
    ...
    strings_ru = {
        ...
        "inline_settings": "⚙️ <b>Здесь можно управлять настройками adaptator</b>",
        ...
        "_cls_doc": "Дополнительные настройки adaptator",
        "nonick_warning": (
            "Внимание! Ты включил NoNick со стандартным префиксом! "
            "Тебя могут замьютить в чатах adaptator. Измени префикс или "
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит adaptator с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с adaptator будут удалены\n- Сессия"
            " adaptator будет сброшена\n- Инлайн бот adaptator будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить adaptator?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю adaptator...</b>",
        "uninstalled": (
            "😢 <b>adaptator удалён. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
        "cmd_nn_list": (
        ...
        "privacy_leak": (
            "⚠️ <b>Эта команда дает доступ к веб-интерфейсу adaptator. Ее выполнение в"
        ...
        "opening_tunnel": "🔁 <b>Открываю тоннель к веб-интерфейсу adaptator...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Закрыть",
        "lavhost_web": (
            "✌️ <b>По этой ссылке ты попадешь в веб-интерфейс adaptator на"
    ...
    async def _uninstall(self, call: InlineCall):
        ...
        async for dialog in self._client.iter_dialogs(
            ...
            if (
                ...
                and (
                    ...
                    and dialog.name in {"adaptator-logs", "silent-tags"}
                )
                or (
        ...
        if any(folder.title == "adaptator" for folder in folders):
            folder_id = max(
                folders,
                key=lambda x: x.id,
            ).id
    ...
    @loader.owner
    @loader.command(ru_doc="Удалить adaptator")
    async def uninstall_adaptator(self, message: Message):
        """Uninstall adaptator"""
    ...
    @loader.owner
    @loader.command(ru_doc="Открыть тоннель к веб-интерфейсу adaptator")
    async def weburl(self, message: Message, force: bool = False):
        """Opens web tunnel to your adaptator web interface"""
