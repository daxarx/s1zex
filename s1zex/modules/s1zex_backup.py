...
@loader.tds
class AdaptatorBackupMod(loader.Module):
    """Automatic database backup"""

    strings = {
        "name": "AdaptatorBackup",
        "period": (
    ...
    strings_ru = {
        "period": (
            ...
            "</b>‼️<b> Не с кем не делитесь файлами конфига, даже с разработчиками adaptator! Они содержат конфиденциальные данные\n\n"
    ...
    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://github.com/s1zexxx/Adaptator/raw/main/assets/BackUp.png",
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://github.com/hikariatama/assets/raw/master/s1zex-backups.png",
            _folder="s1zex",
        )
    ...
    async def handler(self):
        try:
            ...
            backup.name = "adaptator-db-backup-{}.json".format(
            ...
            logger.exception("adaptatorBackup failed")
