...
@loader.tds
class AdaptatorInfoMod(loader.Module):
    """Show userbot info"""
    ...
    strings = {
        ...
        "desc": (
            ...
            ' href="https://github.com/s1zexxx/Adaptator">GitHub</a>'
        ),
    }
    ...
    strings_ru = {
        ...
        "desc": (
            "<emoji document_id=5062291541624619917>😀</emoji> <b>adaptator</b>"
            " Юзербот, основанный на s1zex с богатым функционалом."
            " Юзербот работает во всех чатах от имени твоего аккаунта. <b>Исходный код adaptator можешь всегда посмотреть на <a"
            ' href="https://github.com/s1zexxx/Adaptator>GitHub</a>'
        ),
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://github.com/s1zexxx/Adaptator/raw/main/assets/adapt_info.mp4",
    ...
    async def client_ready(self):
        ...
        if self.config["banner_url"] == "https://github.com/s1zexxx/Adaptator/raw/main/assets/adapt_info.mp4":
            self.config["banner_url"] = "https://github.com/s1zexxx/Adaptator/raw/main/assets/adapt_info.mp4"
    ...
    @loader.inline_handler(thumb_url="https://te.legra.ph/file/af8d6f54ce72d1e524958.jpg")
    ...
    async def Info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/s1zexxx/Adaptator/raw/main/assets/bot_pfp.png"
            ),
    ...
    @loader.command(ru_doc="Отправить информацию по типу 'Что такое adaptator?'",)
    async def whoadaptator(self, message: Message):
        """Send info aka 'What is adaptator?'"""
