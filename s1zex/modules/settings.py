...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "adaptator": (
            "{} <b>{}.{}.{}</b> <i>{}</i>\n\n<b><emoji"
            " document_id=5377437404078546699>💜</emoji> <b>Telethon:"
            "</b> <i>{}</i>\n{}"
            " <b>Pyrogram:</b> <i>{}</i>\n"
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>adaptator:</b> <i>V1.6.1</i>\n<emoji"
            " document_id=5281005969420066218>🥀</emoji>"
            " <b>Developers: s1zexbee.t.me/3</b>"
        ),
        ...
        "prefix_collision": (
            "<emoji document_id=5469654973308476699>💣</emoji> <b>Your Dragon and adaptator"
    ...
    strings_ru = {
        ...
        "adaptator": (
            ...
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>adaptator:</b> <i>V1.6.1</i>\n<emoji"
            " document_id=5281005969420066218>🥀</emoji>"
            " <b>Разработчики: s1zexbee.t.me/3</b>"
        ),
    ...
    strings_uk = {
        ...
        "adaptator": (
            ...
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>adaptator:</b> <i>V1.6.1</i>\n<emoji"
            " document_id=5281005969420066218>🥀</emoji>"
            " <b>Розробники: s1zexbee.t.me/3</b>"
        ),
        ...
        "prefix_collision": (
            ...
            " adaptator повинні відрізнятися!</b>"
        ),
    }    
    ...
    @loader.command(
        ru_doc="Показать версию adaptator",
    )
    async def adaptatorcmd(self, message: Message):
        """Get adaptator version"""
        await utils.answer_file(
            message,
            "https://github.com/s1zexxx/Adaptator/raw/main/assets/banner.png",
            self.strings("adaptator").format(
                (
                    (
